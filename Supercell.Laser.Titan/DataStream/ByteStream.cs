namespace Supercell.Laser.Titan.DataStream
{
    ...
    public class ByteStream : ChecksumEncoder
    {
        ...
        public void WriteCompressedString(string value)
        {
            ...
            System.Buffer.BlockCopy(compressed, 0, this.Buffer, this.Offset, compressed.Length);
        ...
        public void WriteIntValueEntry(int key, int value)
        {
            WriteVInt(value);
            WriteVInt(key);
        }
