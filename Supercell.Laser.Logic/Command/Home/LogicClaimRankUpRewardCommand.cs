namespace Supercell.Laser.Logic.Command.Home
{
    ...
    public class LogicClaimRankUpRewardCommand : Command
    {
        ...
        public int BrawlPassSeasonId { get; set; }
        ...
        public override void Decode(ByteStream stream)
        {
            ...
            BrawlPassSeasonId = stream.ReadVInt();
            RequieredMilestone = stream.ReadVInt();
        }

        public override int Execute(HomeMode homeMode)
        {
            Debugger.Print($"Claim rankup reward: milestone: {MilestoneId}, data: {UnknownDataId}, brawlpassseasonId: {BrawlPassSeasonId}, unk3: {Unk3}");
            ...
            {
                string name = $"Goal_{MilestoneId}_{BrawlPassSeasonId}_{(MilestoneId == 10 ? RequieredMilestone : RequieredMilestone)}";
                ...
                if (ProcessReward(homeMode, milestoneData, false, MilestoneId, MilestoneId == 10 ? RequieredMilestone + 2 : RequieredMilestone + 2, BrawlPassSeasonId) != 0) return 0;
        ...
        private int ProcessReward(HomeMode homeMode, MilestoneData milestoneData, bool useSecondaryReward, int track, int idx, int bpSeason)
        {
            ...
            int PrimaryLvlUpRewardExtraData = !useSecondaryReward ? milestoneData.PrimaryLvlUpRewardExtraData : milestoneData.SecondaryLvlUpRewardExtraData;;
            switch (type)
            {
                case (int)ShopItem.UpgradeMaterial:
                    {
                ...
                case (int)ShopItem.GuaranteedHero: 
                    {
                ...
                case (int)ShopItem.WildcardPower:
                    {
                ...
                case (int)ShopItem.QuestsFeature: // Quests unlocked!
                    {
                ...
                case (int)ShopItem.Emote: // Pins
                    ...
                    break;
                case (int)ShopItem.PlayerThumbnail:
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
                ...
                case (int)ShopItem.ClubFeature: // Clubs unlocked!
                    {
                        break;
                    }
                case (int)ShopItem.SpraySlot: // Sprays unlocked!
                    {
                        break;
                    }
                case (int)ShopItem.RecruitToken:
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
                ...
                case (int)ShopItem.DailyQuests: // Dayli Quest
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
                ...
                case (int)ShopItem.Bling: // Blings
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
                ...
                case (int)ShopItem.StarrDropContainer: // Stardrop
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
                ...
                case (int)ShopItem.RandomStarrDrop:
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
                ...
                case (int)ShopItem.BrawlPassUnlockBrawler: // 1000 tokens
                    {
                        LogicGiveDeliveryItemsCommand command = new LogicGiveDeliveryItemsCommand();
                        DeliveryUnit unit = new DeliveryUnit(100);
