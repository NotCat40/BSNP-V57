namespace Supercell.Laser.Logic.Command.Home
{
    ...
    public class LogicSelectSkinCommand : Command
    {
        ...
        public override int Execute(HomeMode homeMode)
        {
            ...
            if (!skinData.Name.EndsWith("Default") && !homeMode.Home.UnlockedSkins.Contains(skinId + 29000000)) return -1;
            if (hero != null) hero.SelectedSkinId = skinId; homeMode.CharacterChanged.Invoke(0);
            return 0;
        }
